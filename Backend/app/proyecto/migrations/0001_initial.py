# Generated by Django 5.0 on 2024-03-16 16:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadoProducto', models.CharField(choices=[('resaccion', 'resaccion'), ('sometido', 'sometido'), ('publicado', 'publicado')], default='En proceso', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('Propuesta', 'Propuesta'), ('Iniciado', 'Iniciado'), ('Ejecucion', 'Ejecucion'), ('Finalizado', 'Finalizado'), ('Detenido', 'Detenido')], default='Propuesta', max_length=50)),
                ...
                ('lineaInvestigacion', models.CharField(max_length=50)),
                ('etapa', models.CharField(choices=[('Aprobado', 'Aprobado'), ('Rechazado', 'Rechazado'), ('Corregir', 'Corregir'), ('Espera', 'Espera')], default='Espera', max_length=50)),
